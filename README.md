...
-dynamic function loading, compilation of function before rendering, definitely linux exclisive: bunch of commented code in main.cpp (uncomment #target_link_libraries(cppproj dl))\
\
To run (linux):\
